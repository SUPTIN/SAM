...
procedure TFormComErro.FormCreate(Sender: TObject);
var
  i, N: Integer;
...
procedure TFormComErro.frDBDataSet1CheckEOF(Sender: TObject;
  var Eof: Boolean);
begin

end;

procedure TFormComErro.frReport1EnterRect(Memo: TStringList;
  View: TfrView);
begin
  chart1.Refresh;
...
procedure TFormComErro.RLBand1AfterPrint(Sender: TObject);
begin

end;

procedure TFormComErro.RLBand2AfterPrint(Sender: TObject);
begin

end;

procedure TFormComErro.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TFormComErro.DbChartSource1GetItem(ASender: TDbChartSource;
  var AItem: TChartDataItem);
const
...
procedure TFormComErro.BitBtn1Click(Sender: TObject);
...
procedure TFormComErro.Chart1AfterDraw(ASender: TChart;
  ADrawer: IChartDrawer);
begin
end;

procedure TFormComErro.Chart1Click(Sender: TObject);
begin
end;

procedure TFormComErro.DataSource1DataChange(Sender: TObject;
  Field: TField);
begin
