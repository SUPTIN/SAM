...
procedure Tfromerrado.FormCreate(Sender: TObject);
const
  N = 2;
var
  i: Integer;
...
procedure Tfromerrado.Image1Click(Sender: TObject);
begin

end;

procedure Tfromerrado.DBGrid1DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin

end;

procedure Tfromerrado.DbChartSource1GetItem(ASender: TDbChartSource;
  var AItem: TChartDataItem);
const
